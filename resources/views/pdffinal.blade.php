  ...
  <body>
    ...
    <header style="position: fixed; top: -174px; left: 0px; right: 0px; height: 108px;padding: .5em; text-align: center;">
      ...
      <div style="padding-top: 100px; width:100%;">
        ...
        <h1 style="padding-right:50px">N° {{$informe->cite}}</h1>
      </div>
      ...
      <footer style="bottom: -0.8cm;left: 0cm;right: 0cm;height: 1cm;color: black ;text-align: left;line-height: 10px;">
          ...
          <table class="table-footer"  cellspacing="0" border="1">
              <tr>
                  ...
                  <th class="ta-footer">{{$json_convertidos->cargo}}</th>
                  @endforeach
              </tr>
              <tr>
              @php($arr=(json_decode($informe->usuario, true)))
    ...
    <main>
        ...
        <h2 style="line-height: 0cm;">{{$informe->cite}}</h2><br><br>
    ...
    <main> 
        ...
        <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
          <span style="font-size:15px; line-height: 0.2cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><u>COMUNICACIÓN INTERNA Nº: DRII-CI-{{$informe->cite_comunicaciones}}-{{$informe->gestion}}</u></strong></span>
        </div>
        ...
        <div class="lineacomunicacioninterna" style="border-top: 3px solid #000000; height: 0px; max-width: 2000px; padding: 0; margin: 2px auto 0 auto;"></div>
        <div style="text-align: justify;"><span style="font-size: 11pt; ">{!! $informe->dato_informe !!}</span></div>
        <style>
    ...
    <main>
      ...
      <h2 style="line-height: 0cm;">Nº: DRII-M-{{$informe->cite_memo}}-{{$informe->gestion}}</h2>
      <style>
        .tablamemorandum{
            width: 625px;
    ...
    <main>
      ...
      <!--Cite del informe-->
      <div style="float:right; font-size:15px; line-height: 0.2cm;"><strong>Nº: DRII-IN-{{$informe->cite_informes}}-{{$informe->gestion}}</strong> </div><br>
      <!--Usuario dirigido A: border-style: solid;-->
      <div style="display: flex; align-items: center;">
        <div style="float:left; margin-top: 10px;" ><span style="font-size:0.8pc;"><strong>A:</strong></span> </div>
      </div>  
    ...
    <main>
      <br>
      <span style="font-size:17px; line-height: 1cm;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>INSTRUCTIVO Nº: {{$informe->cite}}</strong></span><br>
    ...
    <main>
      <br>
      <div style="float:right; font-size:1pc;"><span>Cochabamba, {{$fechaformateada}}</span></div><br>
    ...
    <main>
      @php($year = date("Y", strtotime(now())))
      <div style="float:right; font-size:1pc;"><span>CONV. INST - SG Nº {{$informe->cite}}/{{$informe->gestion}}</span></div><br><br>
        ...
        <table class="table-sign">
              ...
              @else
                  ...
                  @foreach($array_convenio as $index => $array_convenios)
                      ...
                      @endif
                      <td class="td-sign" align="center" style="font-size:14px"> <br><br><br><br>
